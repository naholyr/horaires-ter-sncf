...
public class PreferencesActivity extends CapptainPreferenceActivity {
		...
		switch (id) {
			case DIALOG_CLEAR_HISTORY: {
				return new AlertDialog.Builder(this).setCancelable(true).setTitle("Historique de recherche")
						.setMessage("Vider votre historique de recherche maintenant ?").setIcon(R.drawable.icon).setNegativeButton("Non", null)
